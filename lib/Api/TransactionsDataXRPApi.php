...
class TransactionsDataXRPApi
{
     ...
     * @throws \CryptoapisApiClient\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \CryptoapisApiClient\Model\GetTransactionDetailsByTransactionHashXRPR|\CryptoapisApiClient\Model\GetTransactionDetailsByTransactionHashXRP400Response|\CryptoapisApiClient\Model\GetTransactionDetailsByTransactionHashXRP401Response|\CryptoapisApiClient\Model\GetBlockDetailsByBlockHashUTXOs402Response|\CryptoapisApiClient\Model\GetTransactionDetailsByTransactionHashXRP403Response|\CryptoapisApiClient\Model\GetTransactionDetailsByTransactionHashXRP404Response|\CryptoapisApiClient\Model\GetBlockDetailsByBlockHashUTXOs409Response|\CryptoapisApiClient\Model\GetBlockDetailsByBlockHashUTXOs415Response|\CryptoapisApiClient\Model\GetBlockDetailsByBlockHashUTXOs422Response|\CryptoapisApiClient\Model\GetBlockDetailsByBlockHashUTXOs429Response|\CryptoapisApiClient\Model\GetBlockDetailsByBlockHashUTXOs500Response, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\CryptoapisApiClient\Model\GetTransactionDetailsByTransactionHashXRPR',
                        $request,
                        $response,
                    );
                case 400:
                    return $this->handleResponseWithDataType(
                        '\CryptoapisApiClient\Model\GetTransactionDetailsByTransactionHashXRP400Response',
                        $request,
                        $response,
                    );
                case 401:
                    return $this->handleResponseWithDataType(
                        '\CryptoapisApiClient\Model\GetTransactionDetailsByTransactionHashXRP401Response',
                        $request,
                        $response,
                    );
                case 402:
                ...
                case 403:
                    return $this->handleResponseWithDataType(
                        '\CryptoapisApiClient\Model\GetTransactionDetailsByTransactionHashXRP403Response',
                        $request,
                        $response,
                    );
                case 404:
    ...
    {
        $returnType = '\CryptoapisApiClient\Model\GetTransactionDetailsByTransactionHashXRPR';
        $request = $this->getTransactionDetailsByTransactionHashXRPRequest($network, $transactionHash, $context, $contentType);
