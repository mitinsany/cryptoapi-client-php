...
/**
 * GetBlockDetailsByBlockHashEVMRI Class Doc Comment
 *
 * @category Class
 * @package  CryptoapisApiClient
 * @author   OpenAPI Generator team
 ...
 */
class GetBlockDetailsByBlockHashEVMRI implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetBlockDetailsByBlockHashEVMRI';
    ...
    */
     ...
     * Sets gasLimit
     *
     * @param int $gasLimit Numeric representation of the block gas limit
     *
     * @return self
     */
     ...
     * Sets gasUsed
     *
     * @param int $gasUsed Numeric representation of the block gas used
     *
     * @return self
     */
     ...
     * Sets minedInSeconds
     *
     * @param int $minedInSeconds Numeric representation of the block gas limit
     *
     * @return self
     */
     ...
     *
     * @param int $totalDifficulty Numeric representation of the block total difficulty
     *
     * @return self
     */
