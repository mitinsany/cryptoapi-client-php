<?php
/**
 * ListUnspentTransactionOutputsByAddressUTXOsRIValue
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * ListUnspentTransactionOutputsByAddressUTXOsRIValue Class Doc Comment
 *
 * @category Class
 * @package  CryptoapisApiClient
 * @author   OpenAPI Generator team
 ...
 */
class ListUnspentTransactionOutputsByAddressUTXOsRIValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListUnspentTransactionOutputsByAddressUTXOsRI_value';
    ...
    */
     ...
     * Sets unit
     *
     * @param string $unit Represents the unit of the amount
     *
     * @return self
     */
