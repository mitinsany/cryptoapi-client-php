...
class ListSyncedAddressesRI implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets address
     *
     * @param string $address String representation of the address
     *
     * @return self
     */
     ...
     * Sets blockchain
     *
     * @param string $blockchain Represents the specific blockchain protocol name, e.g. Bitcoin, etc.
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string $id Record identificator used for pagination startingAfter
     *
     * @return self
     */
     ...
     * Sets isActive
     *
     * @param bool $isActive Defines whether the synchronization is active or not.
     *
     * @return self
     */
     ...
     * Sets syncStatus
     *
     * @param string $syncStatus String representation of the synchronization status
     *
     * @return self
     */
