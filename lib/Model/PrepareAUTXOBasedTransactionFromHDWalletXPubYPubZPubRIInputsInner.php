<?php
/**
 * PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIInputsInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIInputsInner Class Doc Comment
 *
 * @category Class
 * @package  CryptoapisApiClient
 * @author   OpenAPI Generator team
 ...
 */
class PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIInputsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PrepareAUTXO_BasedTransactionFromHDWalletXPubYPubZPubRI_inputs_inner';
    ...
    */
     ...
     * Sets outputIndex
     *
     * @param int $outputIndex Representation of the output index
     *
     * @return self
     */
