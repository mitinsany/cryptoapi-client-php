...
/**
 * ListLatestMinedBlocksUTXOsRI Class Doc Comment
 *
 * @category Class
 * @package  CryptoapisApiClient
 * @author   OpenAPI Generator team
 ...
 */
class ListLatestMinedBlocksUTXOsRI implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListLatestMinedBlocksUTXOsRI';
    ...
    */
     ...
     * Sets nextBlockHash
     *
     * @param string|null $nextBlockHash String representation of the next block hash
     *
     * @return self
     */
