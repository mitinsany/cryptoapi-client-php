...
/**
 * GetBlockDetailsByBlockHeightEVMRI Class Doc Comment
 *
 * @category Class
 * @package  CryptoapisApiClient
 * @author   OpenAPI Generator team
 ...
 */
class GetBlockDetailsByBlockHeightEVMRI implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetBlockDetailsByBlockHeightEVMRI';
    ...
    */
     ...
     * Sets nextBlockHash
     *
     * @param string|null $nextBlockHash Representation of the next block hash.
     *
     * @return self
     */
