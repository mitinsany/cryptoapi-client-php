...
/**
 * ListLogsByTransactionHashEVMRI Class Doc Comment
 *
 * @category Class
 * @package  CryptoapisApiClient
 * @author   OpenAPI Generator team
 ...
 */
class ListLogsByTransactionHashEVMRI implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListLogsByTransactionHashEVMRI';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['isRemoved'] === null) {
            $invalidProperties[] = "'isRemoved' can't be null";
        }
     ...
     * Sets isRemoved
     *
     * @param bool $isRemoved Representation of whether the event was removed
     *
     * @return self
     */
