...
class BroadcastLocallySignedTransactionRBDataItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'signedTransactionHex' => 'setSignedTransactionHex'
    ];
    ...
    protected static $getters = [
        ...
        'signedTransactionHex' => 'getSignedTransactionHex'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('signedTransactionHex', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['signedTransactionHex'] === null) {
            $invalidProperties[] = "'signedTransactionHex' can't be null";
        }
     ...
     * Sets callbackUrl
     *
     * @param string|null $callbackUrl Represents the URL that is set by the customer where the callback will be received at. The callback notification will be received only if and when the event occurs. `We support ONLY httpS type of protocol`.
     *
     * @return self
     */
    ...
    /**
     * Gets signedTransactionHex
     *
     * @return string
     */
    public function getSignedTransactionHex()
    {
        return $this->container['signedTransactionHex'];
    }

    /**
     * Sets signedTransactionHex
     *
     * @param string $signedTransactionHex Represents the signed transaction's specific hex.
     *
     * @return self
     */
    public function setSignedTransactionHex($signedTransactionHex)
    {
        if (is_null($signedTransactionHex)) {
            throw new \InvalidArgumentException('non-nullable signedTransactionHex cannot be null');
        }
        $this->container['signedTransactionHex'] = $signedTransactionHex;
