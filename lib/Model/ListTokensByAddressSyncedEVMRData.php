...
class ListTokensByAddressSyncedEVMRData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'sortingOrder' => 'string',
        'items' => '\CryptoapisApiClient\Model\ListTokensByAddressSyncedEVMRI[]'
    ];
    ...
    */
     ...
     * Gets items
     *
     * @return \CryptoapisApiClient\Model\ListTokensByAddressSyncedEVMRI[]
     */
     ...
     * Sets items
     *
     * @param \CryptoapisApiClient\Model\ListTokensByAddressSyncedEVMRI[] $items items
     *
     * @return self
     */
