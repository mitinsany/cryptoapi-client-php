...
class GetBlockDetailsByBlockHashUTXOs402Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'requestId' => 'string',
        'context' => 'string',
        'error' => '\CryptoapisApiClient\Model\InsufficientCredits'
    ];
    ...
    */
     ...
     * Gets error
     *
     * @return \CryptoapisApiClient\Model\InsufficientCredits
     */
     ...
     * Sets error
     *
     * @param \CryptoapisApiClient\Model\InsufficientCredits $error error
     *
     * @return self
     */
