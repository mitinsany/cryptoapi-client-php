...
class ListSyncedAddressesRData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'sortingOrder' => 'string',
        'items' => '\CryptoapisApiClient\Model\ListSyncedAddressesRI[]'
    ];
    ...
    */
     ...
     * Gets items
     *
     * @return \CryptoapisApiClient\Model\ListSyncedAddressesRI[]
     */
     ...
     * Sets items
     *
     * @param \CryptoapisApiClient\Model\ListSyncedAddressesRI[] $items items
     *
     * @return self
     */
