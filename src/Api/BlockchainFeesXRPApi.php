...
/**
 * BlockchainFeesXRPApi Class Doc Comment
 *
 * @category Class
 * @package  MitinSany/CryptoapisApiClient
 * @author   OpenAPI Generator team
...
class BlockchainFeesXRPApi
{
    ...
    /**
     * Operation getFeeRecommendationsXRP
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getFeeRecommendationsXRP'] to see the possible values for this operation
     *
     ...
     * @return \MitinSany/CryptoapisApiClient\Model\GetFeeRecommendationsXRPR|\MitinSany/CryptoapisApiClient\Model\GetFeeRecommendationsXRP400Response|\MitinSany/CryptoapisApiClient\Model\GetFeeRecommendationsXRP401Response|\MitinSany/CryptoapisApiClient\Model\GetBlockDetailsByBlockHashUTXOs402Response|\MitinSany/CryptoapisApiClient\Model\GetFeeRecommendationsXRP403Response|\MitinSany/CryptoapisApiClient\Model\GetTransactionDetailsByTransactionHashXRP404Response|\MitinSany/CryptoapisApiClient\Model\GetBlockDetailsByBlockHashUTXOs409Response|\MitinSany/CryptoapisApiClient\Model\GetBlockDetailsByBlockHashUTXOs415Response|\MitinSany/CryptoapisApiClient\Model\GetBlockDetailsByBlockHashUTXOs422Response|\MitinSany/CryptoapisApiClient\Model\GetBlockDetailsByBlockHashUTXOs429Response|\MitinSany/CryptoapisApiClient\Model\GetBlockDetailsByBlockHashUTXOs500Response
     */
    public function getFeeRecommendationsXRP($network, $context = null, string $contentType = self::contentTypes['getFeeRecommendationsXRP'][0])
    {
        list($response) = $this->getFeeRecommendationsXRPWithHttpInfo($network, $context, $contentType);
        return $response;
    }

    /**
     * Operation getFeeRecommendationsXRPWithHttpInfo
     *
     * Get Fee Recommendations XRP
     *
     * @param  string $network Represents the name of the blockchain network used; blockchain networks are usually identical as technology and software, but they differ in data, e.g. - \&quot;mainnet\&quot; is the live network with actual data while networks like \&quot;testnet\&quot; (required)
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\MitinSany/CryptoapisApiClient\Model\GetFeeRecommendationsXRPR',
                        $request,
                        $response,
                    );
                case 400:
                    return $this->handleResponseWithDataType(
                        '\MitinSany/CryptoapisApiClient\Model\GetFeeRecommendationsXRP400Response',
                        $request,
                        $response,
                    );
                case 401:
                ...
                case 403:
                    return $this->handleResponseWithDataType(
                        '\MitinSany/CryptoapisApiClient\Model\GetFeeRecommendationsXRP403Response',
                        $request,
                        $response,
                    );
                case 404:
    ...
    /**
     * Operation getFeeRecommendationsXRPAsync
     *
     * Get Fee Recommendations XRP
     *
     * @param  string $network Represents the name of the blockchain network used; blockchain networks are usually identical as technology and software, but they differ in data, e.g. - \&quot;mainnet\&quot; is the live network with actual data while networks like \&quot;testnet\&quot; (required)
     ...
     */
    public function getFeeRecommendationsXRPAsync($network, $context = null, string $contentType = self::contentTypes['getFeeRecommendationsXRP'][0])
    {
        return $this->getFeeRecommendationsXRPAsyncWithHttpInfo($network, $context, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getFeeRecommendationsXRPAsyncWithHttpInfo
     *
     * Get Fee Recommendations XRP
     *
     * @param  string $network Represents the name of the blockchain network used; blockchain networks are usually identical as technology and software, but they differ in data, e.g. - \&quot;mainnet\&quot; is the live network with actual data while networks like \&quot;testnet\&quot; (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFeeRecommendationsXRPAsyncWithHttpInfo($network, $context = null, string $contentType = self::contentTypes['getFeeRecommendationsXRP'][0])
    {
        $returnType = '\MitinSany/CryptoapisApiClient\Model\GetFeeRecommendationsXRPR';
        $request = $this->getFeeRecommendationsXRPRequest($network, $context, $contentType);
    ...
    /**
     * Create request for operation 'getFeeRecommendationsXRP'
     *
     * @param  string $network Represents the name of the blockchain network used; blockchain networks are usually identical as technology and software, but they differ in data, e.g. - \&quot;mainnet\&quot; is the live network with actual data while networks like \&quot;testnet\&quot; (required)
     * @param  string|null $context In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. &#x60;context&#x60; is specified by the user. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getFeeRecommendationsXRP'] to see the possible values for this operation
     ...
     */
    public function getFeeRecommendationsXRPRequest($network, $context = null, string $contentType = self::contentTypes['getFeeRecommendationsXRP'][0])
    {

        // verify the required parameter 'network' is set
        if ($network === null || (is_array($network) && count($network) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $network when calling getFeeRecommendationsXRP'
            );
        }



        $resourcePath = '/blockchain-fees/xrp/{network}/mempool';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
