...
/**
 * ListTransactionsByAddressSolanaRITokenBalanceChangesInner Class Doc Comment
 *
 * @category Class
 * @package  MitinSany/CryptoapisApiClient
 * @author   OpenAPI Generator team
 ...
 */
class ListTransactionsByAddressSolanaRITokenBalanceChangesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListTransactionsByAddressSolanaRI_tokenBalanceChanges_inner';
    ...
    */
     ...
     * Sets address
     *
     * @param string $address String representation of the balance change address
     *
     * @return self
     */
