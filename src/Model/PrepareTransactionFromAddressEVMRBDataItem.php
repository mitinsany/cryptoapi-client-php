...
/**
 * PrepareTransactionFromAddressEVMRBDataItem Class Doc Comment
 *
 * @category Class
 * @package  MitinSany/CryptoapisApiClient
 * @author   OpenAPI Generator team
 ...
 */
class PrepareTransactionFromAddressEVMRBDataItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PrepareTransactionFromAddressEVMRB_data_item';
    ...
    protected static $openAPITypes = [
        ...
        'recipient' => 'string',
        'sender' => 'string',
        'fee' => '\MitinSany/CryptoapisApiClient\Model\PrepareTransactionFromAddressEVMRBDataItemFee',
        'type' => 'string'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('type', $data ?? [], 'gas-fee-market-transaction');
    }
    ...
    */
     ...
     * Sets additionalData
     *
     * @param string|null $additionalData Represents an optional note to add a free text in, explaining or providing additional detail on the transaction request.
     *
     * @return self
     */
     ...
     * Gets fee
     *
     * @return \MitinSany/CryptoapisApiClient\Model\PrepareTransactionFromAddressEVMRBDataItemFee
     */
     ...
     * Sets fee
     *
     * @param \MitinSany/CryptoapisApiClient\Model\PrepareTransactionFromAddressEVMRBDataItemFee $fee fee
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type Representation of the transaction type. For Ethereum-Classic and Binance Smart Chain there is no need to provide \"transactionType\" in the request.
     *
     * @return self
     */
