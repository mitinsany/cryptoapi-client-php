<?php
/**
 * PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubEVMRIFee
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubEVMRIFee Class Doc Comment
 *
 * @category Class
 ...
 */
class PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubEVMRIFee implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubEVMRI_fee';
    ...
    */
     ...
     * Sets maxFeePerGas
     *
     * @param int|null $maxFeePerGas Representation of the max fee per gas value
     *
     * @return self
     */
     ...
     *
     * @param int|null $maxPriorityFeePerGas Representation of the max priority fee per gas value
     *
     * @return self
     */
