<?php
/**
 * GetHDWalletXPubYPubZPubAssetsEVMRINonFungibleTokensInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * GetHDWalletXPubYPubZPubAssetsEVMRINonFungibleTokensInner Class Doc Comment
 *
 * @category Class
 * @package  MitinSany/CryptoapisApiClient
 * @author   OpenAPI Generator team
 ...
 */
class GetHDWalletXPubYPubZPubAssetsEVMRINonFungibleTokensInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetHDWalletXPubYPubZPubAssetsEVMRI_nonFungibleTokens_inner';
    ...
    */
     ...
     *
     * @param string $contractAddress Represents tokens' contract address.
     *
     * @return self
     */
     ...
     * Sets tokenId
     *
     * @param string $tokenId Represents tokens' unique identifier.
     *
     * @return self
     */
