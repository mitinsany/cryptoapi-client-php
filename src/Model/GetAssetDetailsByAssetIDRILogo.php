<?php
/**
 * GetAssetDetailsByAssetIDRILogo
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * GetAssetDetailsByAssetIDRILogo Class Doc Comment
 *
 * @category Class
 * @package  MitinSany/CryptoapisApiClient
 * @author   OpenAPI Generator team
 ...
 */
class GetAssetDetailsByAssetIDRILogo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetAssetDetailsByAssetIDRI_logo';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['imageData'] === null) {
            $invalidProperties[] = "'imageData' can't be null";
        }
     ...
     * Sets imageData
     *
     * @param string $imageData Defines the encoded image data as a string.
     *
     * @return self
     */
    public function setImageData($imageData)
    {
        if (is_null($imageData)) {
            throw new \InvalidArgumentException('non-nullable imageData cannot be null');
        }
     ...
     * Sets mimeType
     *
     * @param string $mimeType Defines the image type of the logo - jpg, png, svg, etc.
     *
     * @return self
     */
