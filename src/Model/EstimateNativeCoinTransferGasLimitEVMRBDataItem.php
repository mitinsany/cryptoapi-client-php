...
/**
 * EstimateNativeCoinTransferGasLimitEVMRBDataItem Class Doc Comment
 *
 * @category Class
 * @package  MitinSany/CryptoapisApiClient
 * @author   OpenAPI Generator team
 ...
 */
class EstimateNativeCoinTransferGasLimitEVMRBDataItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EstimateNativeCoinTransferGasLimitEVMRB_data_item';
    ...
    */
     ...
     * Sets additionalData
     *
     * @param string|null $additionalData Represents an optional field to add additonal data.
     *
     * @return self
     */
