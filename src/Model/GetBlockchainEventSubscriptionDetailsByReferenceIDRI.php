...
class GetBlockchainEventSubscriptionDetailsByReferenceIDRI implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets callbackUrl
     *
     * @param string $callbackUrl Represents the URL that is set by the customer where the callback will be received at. The callback notification will be received only if and when the event occurs.
     *
     * @return self
     */
     ...
     *
     * @param int|null $confirmationsCount Represents the number of confirmations, i.e. the amount of blocks that have been built on top of this block.
     *
     * @return self
     */
     ...
     *
     * @return \MitinSany/CryptoapisApiClient\Model\ListBlockchainEventsSubscriptionsRIDeactivationReasonsInner[]|null
     */
     ...
     *
     * @param \MitinSany/CryptoapisApiClient\Model\ListBlockchainEventsSubscriptionsRIDeactivationReasonsInner[]|null $deactivationReasons Represents the deactivation reason details, available when a blockchain event subscription has status isActive - false.
     *
     * @return self
     */
     ...
     * Sets network
     *
     * @param string $network Represents the name of the blockchain network used; blockchain networks are usually identical as technology and software, but they differ in data, e.g. - \"mainnet\" is the live network with actual data while network like \"testnet\" is a test network.
     *
     * @return self
     */
