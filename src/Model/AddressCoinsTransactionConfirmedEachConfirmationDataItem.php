...
class AddressCoinsTransactionConfirmedEachConfirmationDataItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'network' => 'string',
        'address' => 'string',
        'minedInBlock' => '\MitinSany/CryptoapisApiClient\Model\AddressCoinsTransactionConfirmedEachConfirmationDataItemMinedInBlock',
    ...
    */
     ...
     * Sets network
     *
     * @param string $network Represents the name of the blockchain network used; blockchain networks are usually identical as technology and software, but they differ in data, e.g. - \"mainnet\" is the live network with actual data while networks like \"testnet\", \"sepolia\", \"nile\" are test networks.
     *
     * @return self
     */
     ...
     * Gets minedInBlock
     *
     * @return \MitinSany/CryptoapisApiClient\Model\AddressCoinsTransactionConfirmedEachConfirmationDataItemMinedInBlock
     */
     ...
     * Sets minedInBlock
     *
     * @param \MitinSany/CryptoapisApiClient\Model\AddressCoinsTransactionConfirmedEachConfirmationDataItemMinedInBlock $minedInBlock minedInBlock
     *
     * @return self
     */
