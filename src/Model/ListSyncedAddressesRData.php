...
class ListSyncedAddressesRData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'sortingOrder' => 'string',
        'items' => '\MitinSany/CryptoapisApiClient\Model\ListSyncedAddressesRI[]'
    ];
    ...
    */
     ...
     * Gets items
     *
     * @return \MitinSany/CryptoapisApiClient\Model\ListSyncedAddressesRI[]
     */
     ...
     * Sets items
     *
     * @param \MitinSany/CryptoapisApiClient\Model\ListSyncedAddressesRI[] $items items
     *
     * @return self
     */
