...
/**
 * ActivateHDWalletXPubYPubZPubRI Class Doc Comment
 *
 * @category Class
 * @package  MitinSany/CryptoapisApiClient
 * @author   OpenAPI Generator team
 ...
 */
class ActivateHDWalletXPubYPubZPubRI implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ActivateHDWalletXPubYPubZPubRI';
    ...
    */
     ...
     * Sets isActive
     *
     * @param bool $isActive Define the activity status of the hd wallet - if it is active or not
     *
     * @return self
     */
