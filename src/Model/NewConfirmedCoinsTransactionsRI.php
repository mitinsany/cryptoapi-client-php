...
class NewConfirmedCoinsTransactionsRI implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['receiveCallbackOn'] === null) {
            $invalidProperties[] = "'receiveCallbackOn' can't be null";
        }
     ...
     *
     * @param int $receiveCallbackOn Represents the exact confirmation, on which the user wants to receive callback.
     *
     * @return self
     */
