...
/**
 * EstimateTokenTransferGasLimitEVMRBDataItem Class Doc Comment
 *
 * @category Class
 * @package  MitinSany/CryptoapisApiClient
 * @author   OpenAPI Generator team
 ...
 */
class EstimateTokenTransferGasLimitEVMRBDataItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EstimateTokenTransferGasLimitEVMRB_data_item';
    ...
    */
     ...
     * Sets contractType
     *
     * @param string $contractType Represents the ERC contract type. It can be ERC20 or ERC721
     *
     * @return self
     */
