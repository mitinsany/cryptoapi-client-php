<?php
/**
 * GetAddressBalanceUTXOsRIConfirmedBalance
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * GetAddressBalanceUTXOsRIConfirmedBalance Class Doc Comment
 *
 * @category Class
 * @description Object containing the balance amount details
 * @package  MitinSany/CryptoapisApiClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class GetAddressBalanceUTXOsRIConfirmedBalance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetAddressBalanceUTXOsRI_confirmedBalance';
    ...
    */
     ...
     * Sets amount
     *
     * @param string $amount Numeric representation of the total balance of the address
     *
     * @return self
     */
     ...
     * Sets denomination
     *
     * @param int $denomination Integer value representing the denomination of the amount from the main unit
     *
     * @return self
     */
