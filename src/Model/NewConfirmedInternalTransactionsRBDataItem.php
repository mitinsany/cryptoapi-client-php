...
class NewConfirmedInternalTransactionsRBDataItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'receiveCallbackOn' => 'setReceiveCallbackOn'
    ];
    ...
    protected static $getters = [
        ...
        'receiveCallbackOn' => 'getReceiveCallbackOn'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('allowDuplicates', $data ?? [], false);
        $this->setIfExists('callbackSecretKey', $data ?? [], null);
        $this->setIfExists('callbackUrl', $data ?? [], null);
        $this->setIfExists('receiveCallbackOn', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['allowDuplicates'] === null) {
            $invalidProperties[] = "'allowDuplicates' can't be null";
        }
        if ($this->container['callbackSecretKey'] === null) {
            $invalidProperties[] = "'callbackSecretKey' can't be null";
        }
     ...
     *
     * @param bool $allowDuplicates Flag that permits or denies creation of duplicates
     *
     * @return self
     */
    ...
    /**
     * Gets receiveCallbackOn
     *
     * @return int|null
     */
    public function getReceiveCallbackOn()
    {
        return $this->container['receiveCallbackOn'];
    }

    /**
     * Sets receiveCallbackOn
     *
     * @param int|null $receiveCallbackOn Represents the exact confirmation, on which the user wants to receive callback.
     *
     * @return self
     */
    public function setReceiveCallbackOn($receiveCallbackOn)
    {
        if (is_null($receiveCallbackOn)) {
            throw new \InvalidArgumentException('non-nullable receiveCallbackOn cannot be null');
        }
        $this->container['receiveCallbackOn'] = $receiveCallbackOn;
